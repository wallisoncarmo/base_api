...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API REST Spring",
				"Estrutura basica de uma API Spring.", "Versão 1.0",
				"https://github.com/wallisoncarmo/base_api",
				new Contact("Wallison do Carmo Costa", "https://github.com/wallisoncarmo/base_api", "wallisoncarmo01@gmail.com"),
				null, 
